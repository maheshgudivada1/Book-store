...
const Login = () => {
  ...
  const onSubmitSuccess = () => {
    setShowPopup(true); // Show the popup after successful login or registration
  };
  ...
  // Mocked login functionality for demo purposes
  const submitLoginForm = (event) => {
    event.preventDefault();

    // Simulate login with predefined credentials
  ...
  // Mocked registration functionality
